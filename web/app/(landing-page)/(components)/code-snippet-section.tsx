...
const BASE_URL = 'https://api.smartsms.dev/api/v1'
...
BASE_URL = 'https://api.smartsms.dev/api/v1'
...
print(response.json())`,
  },
  {
    tech: "cURL",
    language: "bash",
    snippet: `curl -X POST "https://api.smartsms.dev/api/v1/gateway/devices/YOUR_DEVICE_ID/send-sms" \\
  -H 'x-api-key: YOUR_API_KEY' \\
  -H 'Content-Type: application/json' \\
  -d '{
    "recipients": [ "+1234567890" ],
    "message": "Hello from smartsms.dev"
  }'`,
  },
];
