      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="mx-auto max-w-3xl text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let&apos;s explore how we can customize smartsms to align perfectly
          ...
          <Link
            href={`mailto:contact@smartsms.dev?subject=Customization Request&body=I am interested in discussing paid solutions for smartsms.`}
          >
            <Button
              size="lg"
