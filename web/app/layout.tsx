...
export const metadata: Metadata = {
  title: "smartsms.dev - Free and Open-Source SMS Gateway",
  description:
    "smartsms is an open-source solution that turns your Android device into a powerful SMS gateway. Send SMS effortlessly through your applications.",
  authors: [
    { name: "Israel Abebe Kokiso", url: "https://israelabebe.com" },
    { name: "vernu.dev", url: "https://vernu.dev" },
  ],
  applicationName: "smartsms.dev",
  keywords: [
    "smartsms",
    "sms gateway",
    "open-source",
  ...
  metadataBase: new URL("https://smartsms.dev"),
};
